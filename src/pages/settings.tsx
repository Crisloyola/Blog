...
import { editAuthor } from '../api/authors.api';
    ...
    return (
        <>
            ...
            <section className="flex justify-center mt-12 px-4">
                <div className="w-full max-w-2xl bg-gray-900 rounded-xl shadow-lg border border-white/10 p-8">
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                className="w-full rounded-md bg-white/5 px-3 py-2 text-white placeholder-gray-500 outline outline-1 outline-white/10 focus:outline-2 focus:outline-indigo-500"
                            />
                        </div>
